    ...
    <div className="flex-1 overflow-y-auto bg-[#f0f2f5] dark:bg-[#111b21] p-4 sm:p-6 space-y-2 sm:space-y-4 sm:space-y-8 custom-scrollbar pb-24 font-sans">
      {loading && (
        <div className="flex flex-col items-center justify-center py-32">
          ...
          <p className="text-sm font-bold text-slate-700 dark:text-slate-200 tracking-normal">Synchronizing Uplink...</p>
        </div>
      )}
        ...
        <>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-5 sm:gap-4 sm:gap-8">
            <div>
              ...
              <p className="text-base font-bold text-slate-700 dark:text-slate-200 tracking-normal mt-4 ml-1">Teacher Operations Terminal</p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6">
            {overviewStats.map((s, i) => (
              ...
              >
                ...
                <p className="text-base font-bold text-slate-700 dark:text-slate-200 tracking-normal mb-2">
                  {s.label}
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-4 sm:gap-8 w-full max-w-none">
              ...
              <div className="bg-white dark:bg-[#202c33] p-4 sm:p-6 sm:p-10 rounded-3xl shadow-sm border border-slate-50 dark:border-white/5">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 sm:mb-10 border-b border-slate-50 dark:border-white/5 pb-8 gap-3 sm:gap-6">
                  <div>
                    ...
                    <p className="text-base font-bold text-slate-700 dark:text-slate-200 tracking-normal mt-2">Course Personnel Directory</p>
                  </div>
                  <button
                        ...
                        >
                          <div className="flex items-center gap-5 relative z-10">
                            ...
                            <div>
                              ...
                              <p className={`text-base font-bold tracking-normal mt-1.5 ${isActive ? "text-white" : "text-slate-700 dark:text-slate-200"}`}>
            ...
            <div className="lg:col-span-5 space-y-4 sm:space-y-8 w-full">
              ...
              <div className="bg-white dark:bg-[#202c33] p-4 sm:p-5 sm:p-6 rounded-3xl shadow-sm border border-slate-50 dark:border-white/5">
                 <h2 className="text-base font-bold text-slate-800 dark:text-slate-100 tracking-normal mb-4 sm:mb-8 flex items-center gap-2">
                 ...
                 <div className="grid grid-cols-1 gap-4">
                  ...
                  >
                    ...
                    <div className="text-left">
                       ...
                       <p className="text-base font-bold text-slate-700 dark:text-slate-200 tracking-normal mt-1">Uplink Generator</p>
                    </div>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <div className="text-left">
                       ...
                       <p className="text-base font-bold text-slate-700 dark:text-slate-200 tracking-normal mt-1">Ledger Manager</p>
                    </div>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <div className="text-left">
                       ...
                       <p className="text-sm font-bold text-slate-700 dark:text-slate-200 tracking-normal mt-1">System Admin</p>
                    </div>
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-[#202c33] rounded-3xl shadow-sm border border-slate-50 dark:border-white/5 overflow-hidden flex flex-col h-[550px]">
                <div className="p-4 sm:p-5 sm:p-6 bg-[#f8f9fa] dark:bg-[#111b21] border-b border-slate-50 dark:border-white/10 flex justify-between items-center">
                  <div>
                    <h3 className="text-lg font-bold text-slate-800 dark:text-[#e9edef] flex items-center gap-3 tracking-normal">
                      <Clock className="w-5 h-5 text-wa-teal" /> Signal Feed
                    </h3>
                    <p className="text-xs font-bold text-slate-500 dark:text-slate-300 tracking-normal mt-1">Live Telemetry</p>
                  </div>
                  <div className="flex items-center gap-3">
                    <button 
                    ...
                    <div className="px-3 py-1.5 bg-wa-teal/15 text-wa-teal dark:text-wa-green rounded-full font-bold text-xs tracking-normal animate-pulse">
                      Live
                    </div>
                  </div>
                </div>
                <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-2 sm:space-y-4 custom-scrollbar no-scrollbar">
                  {recentAttendance.length === 0 ? (
                    <div className="py-20 text-center opacity-40">
                      ...
                      <p className="text-sm font-bold tracking-normal text-slate-700 dark:text-slate-200">Void Frequency</p>
                    </div>
                  ) : (
                    recentAttendance.map((rec, idx) => (
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-base font-bold text-slate-800 dark:text-[#e9edef] truncate tracking-normal">
                            {rec.studentName}
                          </p>
                          <div className="flex items-center gap-2 mt-1">
                             <p className="text-sm font-bold text-wa-teal dark:text-wa-green tracking-normal truncate">
